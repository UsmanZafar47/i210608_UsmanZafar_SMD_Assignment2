...
class Screen15Activity : AppCompatActivity() {
    ...
    private fun showEditMessageDialog(messageId: String, currentText: String) {
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Update") { dialog, which ->
                ...
                updateMessageInFirebase(messageId, newText)
            }
            .setNegativeButton("Cancel", null)
            .show()
    }

    private fun updateMessageInFirebase(messageId: String, newText: String) {
        val databaseRef = FirebaseDatabase.getInstance().getReference("Chats/$mentorId/Messages/$messageId")
        databaseRef.child("message").setValue(newText)
            .addOnSuccessListener {
                Toast.makeText(this, "Message updated.", Toast.LENGTH_SHORT).show()
                // Refresh your messages list here if necessary
            }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        chatMessagesRecyclerView.adapter = MessageAdapter(messagesList) { messageId, currentText ->
            showEditMessageDialog(messageId, currentText)
        }
